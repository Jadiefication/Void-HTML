...
class DOM(document: Variable<DOM>? = null) : BrowserObject {
    ...
    fun elements(amount: JsValue<Int>, element: JsValue<Element>, call: (BrowserObject) -> Unit): Reference<DOM> {
        ...
        jsReturn =
            "elements(${amount.toJs()}, \"${elementValue.name}\", \"${elementValue.children!!.joinToString("") { it.render() }}\", {$attributes})"
        return applyMethods(call, HTMLElement(), this)
    }

    fun elements(
        amount: JsValue<Int>,
        element: JsValue<HTMLElement>,
        elementInsides: JsValue<String>,
        attribute: JsValue<JsObject>,
        call: (BrowserObject) -> Unit
    ): Reference<DOM> {
    ...
    fun attribute(name: String, call: (JsAttribute) -> Unit): Reference<DOM> {
...
class HTMLElement : BrowserObject {
    ...
    fun attribute(attribute: String): JsValue<String> {
        jsReturn += ".getAttribute(\"$attribute\")"
        return "".asJsValue()
    }

    fun attribute(attribute: Attribute): Reference<HTMLElement> {
        jsReturn += ".setAttribute(\"${attribute.first}\", \"${attribute.second}\")"
        return this.refer()
    }
    ...
    fun before(
        child: JsValue<HTMLElement>,
        element: JsValue<HTMLElement>,
        call: (HTMLElement) -> Unit
...
fun JavaScript.cssClass(
    cssClass: JsValue<String>,
    document: Variable<DOM>? = null,
    call: (HTMLElement) -> Unit
): Reference<DOM> {
    val dom = DOM(document)
...
fun JavaScript.element(
    element: JsValue<Element>,
    document: Variable<DOM>? = null,
    call: (HTMLElement) -> Unit
): Reference<DOM> {
    val dom = DOM(document)
...
fun JavaScript.attribute(
    names: String,
    document: Variable<DOM>? = null,
    call: (JsAttribute) -> Unit
): Reference<DOM> {
    val dom = DOM(document)
