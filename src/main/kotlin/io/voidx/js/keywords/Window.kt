...
import io.voidx.js.keywords.storage.Local
import io.voidx.js.keywords.storage.Session
...
fun JavaScript.prompt(
    message: JsValue<String>? = null,
    defaultText: JsValue<String>? = null,
    window: JsValue<*>? = null
): JsValue<String> {
    val window = Window(window)
    children.add(window)
...
fun JavaScript.timeout(
    function: JsValue<Function<Nothing>>,
    delay: Int = 0,
    args: JsValue<*>? = null,
    window: JsValue<*>? = null
): JsValue<Int> {
